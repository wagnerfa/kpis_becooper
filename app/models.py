...
class TrBalancete(db.Model):
    ...
    Tr_BalanceteConta    = db.Column(db.String(20),  nullable=False)
    Tr_BalanceteBacen    = db.Column(db.String(20),  nullable=False)
    Tr_BalanceteTitulo   = db.Column(db.String(20),  nullable=False)
    ...
    Tr_BalanceteNCredito = db.Column(db.String(20),  nullable=False)
    Tr_BalanceteNDebito  = db.Column(db.String(20),  nullable=False)
    Tr_BalanceteSate90   = db.Column(db.String(20),  nullable=False)
    Tr_BalanceteSapos90  = db.Column(db.String(20),  nullable=False)
    Tr_BalanceteTituloRel= db.Column(db.String(200), nullable=False)
    Tr_BalanceteMesAno   = db.Column(db.String(7),   nullable=False)
    Tr_BalanceteCentroCusto= db.Column(db.String(20),  nullable=False)
